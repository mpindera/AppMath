...
class MainActivitySubtractGame : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main_subtract_game)
        ...
        btnRandomChoiceFirst.setOnClickListener {
            do {
                ...
                textResultNum.text = ""
                name = ""
            } while (textFirstNum.text.toString().toInt() < textSecondNum.text.toString().toInt())
        }
